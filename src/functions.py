    ...
    for block in blocks:
        ...
        match block_type:
            ...
            case BlockType.QUOTE:
                children.append(ParentNode("blockquote", text_to_children(block[1:])))
            case BlockType.UNORDERED_LIST:
                children.append(ParentNode("ul", text_to_children(block)))
            case BlockType.ORDERED_LIST:
                children.append(ParentNode("ol", text_to_children(block)))
